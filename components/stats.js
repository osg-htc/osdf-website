...
import { ArrowUpIcon, FolderDownloadIcon } from '@heroicons/react/solid';
...
function StatCard({ title, value, unit, rate, humanFunction, subtext, icon }) {
  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center w-full h-full p-4 text-white bg-gray-800 rounded shadow-2xl">
