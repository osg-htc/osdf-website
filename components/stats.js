    ...
    <>
      <section className='bg-gray-900 p-6'>
        <div className='container grid grid-cols-2 gap-4'>
          ...
          <StatCard title='Files Read' value={filesRead} rate={filesPerSecond} humanFunction={numberWithCommas} subtext={"Last 30 days"} />
        </div>
      </section>
    </>
  )
...
function StatCard({ title, value, unit, rate, humanFunction, subtext }) {
